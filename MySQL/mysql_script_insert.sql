...
INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Argamassa Interna ACI 20kg", 10.30, 14.90, 50, 10, 100, 1);
INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Argamassa Quartzolit ACI Interno Cinza 20kg", 15.70, 20, 30, 10, 100, 1);
INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Argamassa Colante Para Porcelanato Cinza 20kg", 24, 29.50, 40, 10, 100, 1);

INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Eco Tanque 240L Bombona Casológica", 293.90, 321.30, 10, 3, 15, 2);
INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Cisterna de Polietileno Subterrânea 5.000L", 4485.90, 4830.90, 8, 3, 15, 2);
INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Cisterna de Polietileno 3.000L", 3440.30, 3710.30, 6, 3, 15, 2);

INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Caixa d'água Polietileno 1.000L", 344.30, 370.30, 20, 10, 30, 3);
INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Caixa d'água Polietileno 500L", 229.90, 270, 15, 10, 30, 3);
INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Tanque de Polietileno 5.000L", 2599.99, 2910.90, 10, 3, 15, 3);

INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Calha Moldura Galvanizada C28 3m", 57, 62, 40, 20, 80, 4);
INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Calha de PVC Branco 5m", 132.60, 150.90, 35, 20, 80, 4);

INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Cimento CPB-40 Branco Estrutural 15kg", 49, 52.90, 50, 20, 100, 5);
INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Cimento CP II E 32 Saco de 50kg", 30.80, 35.20, 60, 20, 100, 5);
INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Cimento Comum Cinza Saco 1kg", 2, 3.20, 130, 50, 250, 5);

INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Viga Saligna Bruta 5cmx11cmx3m", 35.90, 39.90, 80, 30, 200, 6);
INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Caibro Bruto Saligna 5cmx5,7cmx3m", 15.90, 18.40, 70, 30, 200, 6);
INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Caibro Eucalipto Natural Bruto 6cmx6cmx3m", 20, 23.10, 100, 30, 200, 6);

INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Telha Fibrocimento 2,44mx1,10mx5mm", 53.20, 55.10, 90, 20, 150, 7);
INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Telha Polipropileno 2,44mx1,10m", 100, 110.20, 70, 20, 150, 7);
INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Telha de PVC Plan Cerâmica 2,42x0,88m", 120.30, 133.40, 100, 20, 150, 7);

INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Bloco de Concreto Vedação Vazado 9x19x39cm", 2.50, 3, 200, 50, 400, 8);
INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Canaleta de Concreto 19x19x39cm", 5, 6.20, 170, 50, 400, 8);
INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Bloco Cerâmico Vedação 11,5x14x24cm", 1, 1.40, 210, 50, 400, 8);
INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Canaleta Cerâmica 11,5x14x24cm", 2, 2.40, 210, 50, 400, 8);
INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Tijolo Comum Vermelho 8,7x4,3x18,6cm", 0.50, 1, 250, 50, 500, 8);
INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Meio Tijolo Modular 12,5x6,0x12,5cm", 2, 2.40, 210, 50, 500, 8);
INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Tijolo Colonial Vermelho 12,8cmx7,6cmx27,8cm", 3, 3.70, 100, 50, 500, 8);
INSERT INTO `produto` (`nome`, `PrecoCusto`, `PrecoVenda`, `QntEstoque`, `QntEstoqueMin`, `QntEstoqueMax`, `Categoria_idCategoria`) 
VALUES ("Tijolo Refratário 11,5x23x5,1cm", 6.80, 7.40, 180, 50, 500, 8);
